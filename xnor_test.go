...
func TestXnor_Zero_Zero_Is_One(t *testing.T) {
...
func TestXnor_One_One_Is_One(t *testing.T) {
	a, b := bitmap.Bitmap{}, bitmap.Bitmap{}
	a.Grow(64)
	b.Grow(64)
	a.Ones()
...
func TestXnor_One_Zero_Is_Zero(t *testing.T) {
	a, b := bitmap.Bitmap{}, bitmap.Bitmap{}
	a.Grow(64)
	b.Grow(64)
	a.Ones()
...
func TestXnor_Zero_One_Is_Zero(t *testing.T) {
	a, b := bitmap.Bitmap{}, bitmap.Bitmap{}
	a.Grow(64)
	b.Grow(64)
	b.Ones()
