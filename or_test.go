...
func TestOr_Zero_Zero_Is_Zero(t *testing.T) {
	a, b := bitmap.Bitmap{}, bitmap.Bitmap{}
	a.Grow(64)
	b.Grow(64)
	res := logicgate.Or(a, b)
	assert.False(t, res.Contains(1))
}

func TestOr_Zero_One_Is_One(t *testing.T) {
	a, b := bitmap.Bitmap{}, bitmap.Bitmap{}
	a.Grow(64)
	b.Grow(64)
	b.Ones()
...
func TestOr_One_Zero_Is_One(t *testing.T) {
	a, b := bitmap.Bitmap{}, bitmap.Bitmap{}
	a.Grow(64)
	b.Grow(64)
	a.Ones()
...
func TestOr_One_One_Is_One(t *testing.T) {
	a, b := bitmap.Bitmap{}, bitmap.Bitmap{}
	a.Grow(64)
	b.Grow(64)
	a.Ones()
